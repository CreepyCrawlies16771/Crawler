...
public class RobotConfig {
    ...
    // -----------------------------------------------------------------------
    static String FRONT_LEFT     = "fl";
    static String FRONT_RIGHT    = "fr";
    static String BACK_LEFT      = "bl";
    static String BACK_RIGHT     = "br";
    ...
    // -----------------------------------------------------------------------
    // Robot base — not tuned, physical hardware limits
    // -----------------------------------------------------------------------
