...
public class AprilTagWebcam {
    ...
    public double getAngle(AprilTagDetection apd, Rotation rotation) {
        if (apd == null || apd.ftcPose == null) return 0.0; // Safety first

        switch (rotation) {
            case ROLL:    return apd.ftcPose.roll;
            case PITCH:   return apd.ftcPose.pitch;
            case YAW:     return apd.ftcPose.yaw;
            case RANGE:   return apd.ftcPose.range;   // This is in CM based on your init
            case BEARING: return apd.ftcPose.bearing;
            default:      return 0.0;
        }
    }
